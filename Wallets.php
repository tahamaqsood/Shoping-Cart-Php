...
<div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
  ...
  <a class="dropdown-item" href="Gift-Articals.php">Gift Articles</a>
  <a class="dropdown-item" href="Greeting-cards.php">Greeting Cards</a>
  <a class="dropdown-item" href="Dolls.php">Dolls</a>
  <a class="dropdown-item" href="Wallets.php">Wallets</a>
  <a class="dropdown-item" href="Beauty-products.php">beauty products</a>
...
<div class="hearer_icon d-flex">
  ...
  <div class="dropdown cart">
    <a href="cart.html"><i class="fas fa-cart-plus" id="navbarDropdown3" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i></a>
...
<div class="row align-items-center latest_product_inner">
  ...
  <div class="col-lg-4 col-sm-6">
    <div class="single_product_item">
      ...
      <div class="single_product_text">
        <h4>Wooden Case Box</h4>
        <h3>Rs1300.00</h3>
        <a href="cart.html" class="add_cart">+ add to cart<i class="ti-heart"></i></a>
      </div>
    </div>
  </div>
  <div class="col-lg-4 col-sm-6">
...
<div class="col-lg-4 col-sm-6">
  <div class="single_product_item">
    <img src="img/product/xproduct_6.png.pagespeed.ic.zcUuYW5UEY.png" alt="">
    <div class="single_product_text">
      <h4>Quartz Belt Watch</h4>
      <h3>Rs2000.00</h3>
      <a href="#" class="add_cart">+ add to cart<i class="ti-heart"></i></a>
...
<div class="col-lg-4 col-sm-6">
  <div class="single_product_item">
    <img src="img/product/xproduct_7.png.pagespeed.ic.rnieT7kDrD.png" alt="">
    <div class="single_product_text">
      <h4>Quartz Belt Watch</h4>
      <h3>Rs2900.00</h3>
      <a href="#" class="add_cart">+ add to cart<i class="ti-heart"></i></a>
...
<div class="col-lg-4 col-sm-6">
  <div class="single_product_item">
    <img src="img/product/xproduct_8.png.pagespeed.ic.c_yTDNfIir.png" alt="">
    <div class="single_product_text">
      <h4>Quartz Belt Watch</h4>
      <h3>Rs1700.00</h3>
      <a href="#" class="add_cart">+ add to cart<i class="ti-heart"></i></a>
